...
Once my program is completed, it will be distributed through Unity's distribution services. 
A user can just download the program from there. Using the softward is opening and playing the game.
I don't know what else I can say about the use cases.
